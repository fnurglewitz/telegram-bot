...
public final class Chat {
	...
	/**
	 * <em>Optional.</em> Username, for private chats, supergroups and channels
	 * if available
	 */
	 ...
	 *            <em>Optional.</em> Title, for channels and group chats
	 * @param username
	 *            <em>Optional.</em> Username, for private chats, supergroups
	 *            and channels if available
	 * @param firstName
	 *            <em>Optional.</em> First name of the other party in a private
	 *            chat
	 * @param lastName
	 *            <em>Optional.</em> Last name of the other party in a private
	 *            chat
	 */
