...
public class InlineQueryResultCachedVideo extends InlineQueryResult {
	...
	public final String video_file_id;
	...
	public InlineQueryResultCachedVideo(@JsonProperty("id") String id,
			@JsonProperty("video_file_id") String video_file_id, @JsonProperty("title") String title,
