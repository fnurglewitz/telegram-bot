...
public class InlineQueryResultGif extends InlineQueryResult {
	 ...
	 */
	public InlineQueryResultGif(@JsonProperty(JSON_FIELD_ID) String id, @JsonProperty(JSON_FIELD_GIF_URL) String gifUrl,
			@JsonProperty(JSON_FIELD_GIF_WIDTH) Integer gifWidth,
			@JsonProperty(JSON_FIELD_GIF_HEIGHT) Integer gifHeight, @JsonProperty(JSON_FIELD_THUMB_URL) String thumbUrl,
